...
@Module({
  imports: [TypeOrmModule.forFeature([CommentEntity, PostEntity]), PostsModule],
  providers: [CommentsResolver, CommentsService, CommentsAnalyticsService, CommentIndexService],
